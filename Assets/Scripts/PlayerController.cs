...
public class PlayerController : MonoBehaviour 
{
	...
	void Update () 
	{
        ...
        if(Input.GetButtonDown("Fire3") && LevelManager.hasMouse)
        {
            ...
            levelManager.mousePlayer.transform.position = new Vector3(levelManager.player.transform.position.x,
        ...
        if(Input.GetButtonDown("Jump") && LevelManager.hasBat)
        {
            ...
            levelManager.batPlayer.transform.position = new Vector3(levelManager.player.transform.position.x,
                levelManager.player.transform.position.y,
                levelManager.player.transform.position.z);
            levelManager.player.SetActive(false);
